...
namespace Mobilya_Sitesi.Models.ViewModels.User
{
    public class CreateUserViewModel
    {
        ...
        [MinLength(5,ErrorMessage ="Lütfen en az 5 karakter uzunluğunda kullanıcı adı giriniz.")]
        public string? UserName { get; set; }
        [DataType(DataType.Password)]
		[Required(ErrorMessage = "Lütfen geçerli bir parola giriniz.")]
		[MinLength(5,ErrorMessage = "Lütfen en az 5 karakter uzunluğunda parola giriniz.")]
